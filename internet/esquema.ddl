CREATE TABLE CUENTA (IBAN VARCHAR NOT NULL, Tipo_Cuenta VARCHAR(31), SWIFT VARCHAR, ESTADO BOOLEAN, FECHA_APERTURA DATE, NOMBREBANCO VARCHAR NOT NULL, PAIS VARCHAR, SALDO VARCHAR NOT NULL, SUCURSAL VARCHAR, CLASIFICACION VARCHAR, FECHA_CIERRE DATE, CLIENTE_ID VARCHAR, COMISION DOUBLE, CUENTA_REFERENCIA_IBAN VARCHAR, PRIMARY KEY (IBAN))
