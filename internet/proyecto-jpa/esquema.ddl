...
CREATE TABLE CUENTA (IBAN VARCHAR NOT NULL, Tipo_Cuenta VARCHAR(31), SWIFT VARCHAR, ESTADO BOOLEAN, FECHA_APERTURA DATE, NOMBREBANCO VARCHAR NOT NULL, PAIS VARCHAR, SALDO VARCHAR NOT NULL, SUCURSAL VARCHAR, DIVISA_ABREVIATURA VARCHAR(3), CLASIFICACION VARCHAR, FECHA_CIERRE DATE, CLIENTE_ID VARCHAR, COMISION DOUBLE, CUENTA_REFERENCIA_IBAN VARCHAR, PRIMARY KEY (IBAN));
...
CREATE TABLE TRANSACCION (ID_UNICO VARCHAR NOT NULL, CANTIDAD DOUBLE NOT NULL, COMISION DOUBLE, INTERNACIONAL BOOLEAN, TIPO VARCHAR NOT NULL, FECHAEJECUCION DATE, FECHAINSTRUCCION DATE NOT NULL, CUENTA_IBAN VARCHAR, DIVISA_ABREVIATURA VARCHAR(3), PRIMARY KEY (ID_UNICO));
