...
CREATE TABLE USUARIO (ID BIGINT NOT NULL, ESADMINISTRATIVO BOOLEAN NOT NULL, NOMBRE VARCHAR NOT NULL UNIQUE, PASSWORD VARCHAR NOT NULL, INDIVIDUAL_ID VARCHAR, PERSONAAUTORIZADA_ID BIGINT, PRIMARY KEY (ID));
...
ALTER TABLE USUARIO ADD CONSTRAINT FK_USUARIO_INDIVIDUAL_ID FOREIGN KEY (INDIVIDUAL_ID) REFERENCES CLIENTE (ID);
ALTER TABLE USUARIO ADD CONSTRAINT FK_USUARIO_PERSONAAUTORIZADA_ID FOREIGN KEY (PERSONAAUTORIZADA_ID) REFERENCES PERSONAAUTORIZADA (ID);
